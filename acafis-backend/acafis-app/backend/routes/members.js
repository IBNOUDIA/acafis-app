...
const { getMembers, getMember, getMyMember, createMember, updateMember, deleteMember, getMemberStats } = require('../controllers/memberController');
const { protect, authorize } = require('../middleware/auth');

router.use(protect);

router.get   ('/stats', authorize('super_admin','admin','admin_finance'), getMemberStats);
router.get   ('/me',    getMyMember);
...
router.delete('/:id',   authorize('super_admin','admin'), deleteMember);
