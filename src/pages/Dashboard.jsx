...
import Navbar, { BOUTIQUE_URL } from '../components/Navbar';
            ...
            <div style={{ marginBottom: '1rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '0.85rem' }}>
                {[
                  ...
                  { icon: '🛍️', label: t('Boutique', 'Shop', 'Boutik'),              sublabel: t('Au profit de la coop', 'Supports the co-op', 'Ndimbal koperatiw bi'), path: BOUTIQUE_URL, color: '#c9973a', external: true },
                ].map((mod, i) => (
                  // 🔑 navigate() au lieu de window.location.href — c'était la cause principale de la lenteur
                  // Les modules "external" (ex: Facebook, Boutique) s'ouvrent dans un nouvel onglet
                  <div key={i} onClick={() => {
