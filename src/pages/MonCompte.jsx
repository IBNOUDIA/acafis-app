  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setDocuments(docsRes.data.documents.filter(
    ...
    <div style={{ minHeight: '100vh', background: '#f8f5ef', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ padding: '2rem', maxWidth: '1000px', margin: '0 auto' }}>
        ...
        {loading ? (
          ...
          <>
            {notFound ? (
              <div style={{ background: '#fff', borderRadius: '10px', padding: '2rem', textAlign: 'center', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', marginBottom: '1.5rem' }}>
